 ...
 *      Modul: <em>DAP1</em>
 *  </p>
 *  <h2>Dokumentation der Klasse DoublyLinkedList [11.1]</h2>
 *  <p>
 ...
 *  </p>
 *  <h3>Cangelog (Vergelich zu Version 10.2)</h3>
 *  <p>
 *      <span style="color:red;">- reverseIterator()</span><br />
 *      <span style="color:darkgreen;">+ Strategien</span><br />
 *  </p>
 * </center>
 */
public class DoublyLinkedList
{
     ...
     *      - Die Methode gibt gem&auml;&szlig; der Implementierung der abstrakten Klasse (außerhalb der Klasse 'DoublyLinkedList') ein Objekt vom Typ ('Object') an die 
     ...
     *          -> Es k&ouml;nnen also &Auml;nderungen an der Liste vorgenommen werden, die in der ausf&uuml;hrung von 'substitute( Object ref )' bestimmt werden.
     *  </p>
     * </center>
     */
     ...
     * </p>
     */
    public void substituteAll( SubstitutionStrategy s )//Als Argument wird ein zu 'SubstitutionStrategy' kompatibles Objekt erwartet
    {
